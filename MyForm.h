...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->открытьToolStripMenuItem->Size = System::Drawing::Size(231, 32);
			...
			this->сохранитьToolStripMenuItem->Size = System::Drawing::Size(231, 32);
			...
			this->сохранитьКакToolStripMenuItem->Size = System::Drawing::Size(231, 32);
			...
			this->выходToolStripMenuItem->Size = System::Drawing::Size(231, 32);
...
private: System::Void Vstavka_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	InputDialog->setJanr(Convert::ToString("Классическая музыка"));
	...
	else
	{
		...
		{
			MessageBox::Show("Выделено больше одной композиции", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	}
	// Janr->Items[1] - выбрать элемент 1 из DataGridView Janr 
...
private: System::Void Edit_Click(System::Object^ sender, System::EventArgs^ e) {
	if (dgv->SelectedRows->Count == 0)
	{
		MessageBox::Show("Не выбрано ни одной композиции.", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
